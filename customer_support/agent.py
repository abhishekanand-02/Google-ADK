...
def process_refund(order_id: str, reason: str) -> dict:
    ...
    return {
        ...
        "error_message": (
            f"Cannot refund order in '{order['status']}' status. "
...
def escalate_to_supervisor(issue_summary: str, order_id: str) -> dict:
    ...
    """
    ticket_id = f"TICKET{abs(hash(issue_summary)) % 10000:04d}"
...
root_agent = LlmAgent(
    ...
    description=(
        "Handles customer inquiries about orders and refunds with "
